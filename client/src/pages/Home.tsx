...
const places = [
  {
    name: "Parque dos Pioneiros",
    type: "Atrativo natural",
    description: "Verde, sombra e encontros no coração de Adamantina.",
    rating: "4,9",
    reviews: 42,
    tag: "Família",
    color: "from-emerald-900/90 via-emerald-700/30 to-transparent",
    accent: "bg-emerald-100 text-emerald-800",
    icon: "🌿",
  },
  {
    name: "Museu Municipal",
    type: "Cultura e história",
    description: "Memórias que contam a formação da Nova Alta Paulista.",
    rating: "4,8",
    reviews: 28,
    tag: "História",
    color: "from-stone-900/90 via-stone-700/30 to-transparent",
    accent: "bg-stone-100 text-stone-800",
    icon: "🏛️",
  },
  {
    name: "Feira Criativa",
    type: "Cultura e artesanato",
    description: "Sabores, arte local e encontros aos domingos.",
    rating: "4,7",
    reviews: 19,
    tag: "Agenda",
    color: "from-orange-900/90 via-orange-700/30 to-transparent",
...
const events = [
  { date: "24", month: "MAI", title: "Festival de Inverno", meta: "Sáb · 19h · Praça Élio Micheloni", type: "Cultura" },
  { date: "01", month: "JUN", title: "Circuito Gastronômico", meta: "Dom · 11h · Centro da cidade", type: "Gastronomia" },
  { date: "07", month: "JUN", title: "Trilha dos Pioneiros", meta: "Sáb · 7h · Parque dos Pioneiros", type: "Natureza" },
];
        ...
        <section className="relative overflow-hidden border-b border-[#dfe8e1] bg-[#e8f1ea]">
          ...
          <div className="container relative grid min-h-[560px] items-center gap-12 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-20">
            <div className="max-w-xl">
              ...
              <div className="mt-12 flex items-center gap-7 text-sm text-[#59716b]"><div><strong className="font-display text-2xl text-[#123f36]">+120</strong><span className="ml-2">lugares para conhecer</span></div><div className="h-8 w-px bg-[#bad0bf]" /><div><strong className="font-display text-2xl text-[#123f36]">+35</strong><span className="ml-2">eventos neste mês</span></div></div>
            </div>
