...
export const tenants = mysqlTable("tenants", {
  ...
  publicBrandName: varchar("publicBrandName", { length: 160 }).notNull().default("Viva Adamantina"),
  responsibleSecretariat: varchar("responsibleSecretariat", { length: 180 }).notNull().default("Secretaria de Cultura e Turismo"),
  logoUrl: text("logoUrl"),
  primaryColor: varchar("primaryColor", { length: 20 }).notNull().default("#0d5c4d"),
  secondaryColor: varchar("secondaryColor", { length: 20 }).notNull().default("#c4703a"),
  officialDomain: varchar("officialDomain", { length: 255 }),
  contactEmail: varchar("contactEmail", { length: 320 }),
  contactPhone: varchar("contactPhone", { length: 40 }),
  ombudsmanUrl: text("ombudsmanUrl"),
...
export const places = mysqlTable("places", {
  ...
  cadasturSource: varchar("cadasturSource", { length: 255 }),
  cadasturValidatedAt: timestamp("cadasturValidatedAt"),
  sismapaStatus: mysqlEnum("sismapaStatus", ["not_informed", "pending", "validated", "not_applicable"]).default("not_informed").notNull(),
  sismapaReference: varchar("sismapaReference", { length: 120 }),
  registryNotes: text("registryNotes"),
